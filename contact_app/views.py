...
class Window(QMainWindow):
    ...
    def openEditDialog(self):
        ...
        messageBox = QMessageBox.warning(
            self,
            "Warning!",
            "Do you want to edit the selected contact?",
        ...
        if messageBox == QMessageBox.Ok:
            ...
            # if dialog.exec() == QDialog.Accepted:
            #     self.contactsModel.editContact(dialog.data)
            #     self.table.resizeColumnsToContents()
...
class AddDialog(QDialog):
    ...
    def accept(self):
        ...
        self.data = []
        for field in (self.nameField, self.phoneField, self.emailField, self.notesField):
            if not field.text():
